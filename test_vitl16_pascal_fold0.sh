...
#SBATCH --output=slurm-out/test-vitl16-pascal-fold3-%j.out
...
--fold 3 --nshot 0 \
--weights checkpoints/train_vit_pascal_bsz4_fold0/version_0/checkpoints/result-epoch=1-fewshot_val_iou=50.63.ckpt
