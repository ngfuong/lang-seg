...
class TransLSegModuleZS(TransLSegmentationModuleZS):
    def __init__(self, data_path, dataset, batch_size, base_lr, max_epochs, **kwargs):
        super(TransLSegModuleZS, self).__init__(
    ...
    def add_model_specific_args(parent_parser):
        parser = TransLSegmentationModuleZS.add_model_specific_args(parent_parser)
